...
def load_unified_temp_sensor(p: Path, sensor_name="28-00000076e856", tcol="t_mono") -> pd.DataFrame:
    df = pd.read_parquet(p)
...
def main() -> int:
    ...
    ap.add_argument("--bike", default="BMW K1600GT")
    ...
    temp_sensor = load_unified_temp_sensor(p_tmp, sensor_name="28-00000076e856", tcol="t_mono")
